...
tinymce.PluginManager.add('responsivefilemanager', function (editor) {
    ...
    function openmanager() {
        ...
        var fileUrl = `${settings.external_filemanager_path}dialog.php?type=4&descending=${descending}${sort_by}${rootFolder}${fldr}${crossdomain}&lang=${settings.language}&akey=${akey}`;
